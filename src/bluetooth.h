...
const unsigned int deffaultBaudrate = 9600;
const unsigned int waitTime =	1200;
...
public:
    Bluetooth(unsigned short rx, unsigned short tx, unsigned int br);
    Bluetooth(unsigned short rx, unsigned short tx);
		~Bluetooth();
   
		void begin();
		void reset();
		void setBaudrate(unsigned short tier);
